                    ...
                    return (
                      <div key={i} style={{ background: "var(--surface2)", border: "1.5px solid var(--border)", borderRadius: 12, padding: "12px 14px" }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
                          {[["CA Full","caFull","var(--indigo)"],["Exam Full","examFull","var(--sky)"],["Exam %","examPct","var(--amber)"]].map(([lbl, field, col]) => (
                            <div key={field}>
                              <div style={{ fontSize: 9.5, fontWeight: 700, color: col, letterSpacing: "0.06em", textTransform: "uppercase", marginBottom: 4 }}>{lbl}</div>
                              <input type="number" value={ss[field]} min={0} max={field==="examPct"?100:undefined}
                                onChange={e => { const u = [...subjectSettings]; u[i] = { ...(u[i] || { caFull: 30, examFull: 100, examPct: 70 }), [field]: e.target.value }; setSubjectSettings(u); }}
                          ...
                          return(
                            <div key={i} style={{background:"var(--surface2)",border:"1.5px solid var(--border)",borderRadius:12,padding:"12px 14px"}}>
                              ...
                              <div style={{marginTop:8,fontSize:11,color:"var(--text2)",display:"flex",gap:12}}>
                                ...
                                <span>Total: <b style={{color:"var(--sky)"}}>{Math.round(subFull)}</b></span>
                              </div>
                            </div>
                          );
                        })}
                        ...
                        {Array(activeProject.subjectCount).fill(null).map((_,si)=>{
                          ...
                          return(
                            <div key={si} style={{background:"var(--surface2)",border:"1.5px solid var(--border)",borderRadius:14,overflow:"hidden"}}>
                              ...
                              <div style={{padding:"8px 12px",display:"flex",flexDirection:"column",gap:6}}>
                                {/* CA / Assignments — skip toggle */}
                                <div style={{display:"flex",alignItems:"center",gap:8,paddingBottom:4,borderBottom:"1px solid var(--border)"}}>
                                  <span style={{fontSize:11,fontWeight:700,color:"var(--indigo)",flex:1}}>CA (Assignments)</span>
                                  <label style={{display:"flex",alignItems:"center",gap:5,fontSize:10.5,color:ss.skipCA?"var(--red)":"var(--text2)",fontWeight:600,cursor:"pointer"}}>
                                    <input type="checkbox" checked={!!ss.skipCA}
                                      onChange={e=>updateSubjectSetting(si,"skipCA",e.target.checked)}
                                ...
                                {!ss.skipCA && Array(na).fill(null).map((_,ai)=>(
                                  <div key={ai} style={{display:"flex",alignItems:"center",gap:10}}>
                                    ...
                                    <input type="number" placeholder="0" min={0} max={aoof}
                                      value={(entry.assignments||[])[ai]??""}
                                      onChange={e=>{
                                        setSubjectEntries(prev=>prev.map((en,s)=>{
                                          if(s!==si) return en;
                                ...
                                {ss.skipCA && <div style={{fontSize:11,color:"var(--red)",fontStyle:"italic",padding:"2px 0"}}>CA not counted for this subject</div>}

                                {/* MCQ */}
                                <div style={{display:"flex",alignItems:"center",gap:8,paddingTop:4,borderTop:"1px solid var(--border)"}}>
                                  <span style={{fontSize:11,fontWeight:700,color:"var(--sky)",flex:1}}>MCQ / Oral</span>
                                  <label style={{display:"flex",alignItems:"center",gap:5,fontSize:10.5,color:ss.skipMCQ?"var(--red)":"var(--text2)",fontWeight:600,cursor:"pointer"}}>
                                    <input type="checkbox" checked={!!ss.skipMCQ}
                                      onChange={e=>updateSubjectSetting(si,"skipMCQ",e.target.checked)}
                                      style={{width:"auto",accentColor:"var(--red)",cursor:"pointer"}}/>
                                    Skip
                                  </label>
                                </div>
                                ...
                                <div style={{display:"flex",alignItems:"center",gap:8,paddingTop:2}}>
                                  <span style={{fontSize:11,fontWeight:700,color:"var(--amber)",flex:1}}>CQ / Written</span>
                                  <label style={{display:"flex",alignItems:"center",gap:5,fontSize:10.5,color:ss.skipCQ?"var(--red)":"var(--text2)",fontWeight:600,cursor:"pointer"}}>
                                    <input type="checkbox" checked={!!ss.skipCQ}
                                      onChange={e=>updateSubjectSetting(si,"skipCQ",e.target.checked)}
                                      style={{width:"auto",accentColor:"var(--red)",cursor:"pointer"}}/>
                                    Skip
                                  </label>
                                </div>
                                ...
                                <div style={{fontSize:11,color:"var(--text2)",display:"flex",gap:10,flexWrap:"wrap",paddingTop:4,borderTop:"1px solid var(--border)"}}>
                                  ...
                                  <span>B: <b style={{color:"var(--amber)",fontFamily:"var(--font-mono)"}}>{r.b}</b></span>
                                  <span style={{fontWeight:700}}>Total: <b style={{color:"var(--text)",fontFamily:"var(--font-mono)"}}>{r.ab}</b></span>
