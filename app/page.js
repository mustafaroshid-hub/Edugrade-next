          ...
          <div style={{ animation: "up 0.28s ease", paddingTop: 20 }}>
            {!activeProject ? (
              ...
              <>
                ...
                {reorderModalOpen && (
                  <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.6)", display: "flex", alignItems: "flex-end", justifyContent: "center", zIndex: 100 }} onClick={() => setReorderModalOpen(false)}>
